...
"%CMAKE_EXE%" --preset ps2-release -DPS2_ENABLE_SOUND=ON -DPS2_ENABLE_PERSPECTIVE_TEXTURES=ON -DPS2_RENDER_STATS=ON -DPS2_ENABLE_VU1_TERRAIN=OFF -DMC_LOG_LEVEL=3

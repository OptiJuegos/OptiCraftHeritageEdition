...
{
private:
	void validateRegion(int_t startX, int_t startY, int_t w, int_t h) const;
...
public:
	...
	static std::size_t checkedPixelCount(int_t width, int_t height);
	static std::size_t checkedRgbaByteCount(int_t width, int_t height);

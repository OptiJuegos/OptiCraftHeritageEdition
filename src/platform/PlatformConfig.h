...
#  define PLATFORM_CACHE_NEAREST_PLAYER PLATFORM_PS2
#endif

#ifndef PLATFORM_THROTTLE_ENTITY_AI
#  define PLATFORM_THROTTLE_ENTITY_AI PLATFORM_PS2
#endif
...
#  define PLATFORM_ASYNC_CHUNK_GENERATION PLATFORM_WII
#endif
...
#  define PLATFORM_PROFILE_RENDER_PHASES PLATFORM_PS2
#endif
...
#  define PLATFORM_BOUNDED_PATHFIND (PLATFORM_CONSOLE_LOW || PLATFORM_WII)
#endif
...
#  define PLATFORM_FLOAT_FEATURE_GENERATION PLATFORM_CONSOLE_LOW
#endif
...
// Backends without a persistent native geometry object submit ModelRenderer
// boxes from their current transform. Wii is deliberately excluded: its model
// boxes are compiled once into native GX display lists by ModelRenderer and
// replayed with GX_CallDispList against the live animated modelview.

/*     */ 
/*     */ public class TextureHDWaterFlowFX
/*     */   extends tt
...
/*     */         } 
/*     */         this.buf2[y + x * this.tileWidth] = f / 3.2F + this.buf3[y + x * this.tileWidth] * 0.8F;
/*     */       } 
/*     */     } 
...
/*     */         this.buf4[j + l * this.tileWidth] = this.buf4[j + l * this.tileWidth] - 0.3F;
/*     */         if (Math.random() < 0.2D)
...
/*     */       float f1 = this.buf1[i - this.tickCounter * this.tileWidth & widthMask2];
/*     */       if (f1 > 1.0F)
/*     */         f1 = 1.0F; 
/*     */       if (f1 < 0.0F)
/*     */         f1 = 0.0F; 
...
/* Location:              D:\MC\OptiFine_1.2.5_HD_C6.zip!\TextureHDWaterFlowFX.class

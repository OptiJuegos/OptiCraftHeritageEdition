...
class ComponentVillageWoodHut : public ComponentVillage
{
public:
	ComponentVillageWoodHut(int_t type, Random &random,
	...
	static ComponentVillageWoodHut *findValidPlacement(
...
private:
	...
	const bool isTallHouse;
	const int_t tablePosition;
};

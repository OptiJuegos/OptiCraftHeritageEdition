...
// net.minecraft.src.ComponentNetherBridgeNetherStalkRoom
class ComponentNetherBridgeNetherStalkRoom : public ComponentNetherBridgePiece
{
public:
	ComponentNetherBridgeNetherStalkRoom(int_t componentType, Random &random,
	...
	static ComponentNetherBridgeNetherStalkRoom *createValidComponent(

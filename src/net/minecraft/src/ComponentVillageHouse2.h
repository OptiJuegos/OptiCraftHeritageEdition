...
// net.minecraft.src.ComponentVillageHouse2
class ComponentVillageHouse2 : public ComponentVillage
{
public:
	ComponentVillageHouse2(int_t type, Random &random,
	...
	static ComponentVillageHouse2 *findValidPlacement(

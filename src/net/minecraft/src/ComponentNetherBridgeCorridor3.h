...
// net.minecraft.src.ComponentNetherBridgeCorridor3
class ComponentNetherBridgeCorridor3 : public ComponentNetherBridgePiece
{
public:
	ComponentNetherBridgeCorridor3(int_t componentType, Random &random,
	...
	static ComponentNetherBridgeCorridor3 *createValidComponent(

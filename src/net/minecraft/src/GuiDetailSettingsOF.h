...
// net.minecraft.src.GuiDetailSettingsOF (OptiFine)
class GuiDetailSettingsOF : public GuiScreen
{
public:
	GuiDetailSettingsOF(GuiScreen *parent, GameSettings *gamesettings);

...
// net.minecraft.src.ComponentNetherBridgeCorridor5
class ComponentNetherBridgeCorridor5 : public ComponentNetherBridgePiece
{
public:
	ComponentNetherBridgeCorridor5(int_t componentType, Random &random, const StructureBoundingBox &bounds, int_t direction);
	...
	static ComponentNetherBridgeCorridor5 *createValidComponent(std::vector<StructureComponent *> &components, Random &random,

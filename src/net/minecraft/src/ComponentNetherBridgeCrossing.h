...
{
public:
	ComponentNetherBridgeCrossing(int_t componentType, Random &random, const StructureBoundingBox &bounds, int_t direction);
	...
	static ComponentNetherBridgeCrossing *createValidComponent(std::vector<StructureComponent *> &components, Random &random,

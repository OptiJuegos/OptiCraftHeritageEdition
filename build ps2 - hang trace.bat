...
"%CMAKE_EXE%" --preset ps2-release -DPS2_ENABLE_SOUND=OFF -DPS2_ENABLE_PERSPECTIVE_TEXTURES=ON -DPS2_RENDER_STATS=ON -DPS2_ENABLE_VU1_TERRAIN=ON -DMC_LOG_LEVEL=3
